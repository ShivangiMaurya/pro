...
// console.log(resList.data.sla.maxDeliveryTime,"sla");

// console.log(resList.data.data.name,"sla");
// {
//   resList.map((res)=>console.log(res,"mp"));
// }
...
{/* these list item should be uniquely represented... */}
{
  ...
  (
  <RestaurantCard key={restaurantObj.data.data.id} resName={restaurantObj}/>
  )
      ...
      {/* <RestaurantCard 
      resName={resList[1]}
      // resList[1] that means array ka pehla object
      /> */}
